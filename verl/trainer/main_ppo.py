...
class TaskRunner:
    ...
    def run(self, config):
        ...
        reward_fn = load_reward_manager(
            config, tokenizer, num_examine=0, rewardType='train', **config.reward_model.get("reward_kwargs", {})
        )
        val_reward_fn = load_reward_manager(
            config, tokenizer, num_examine=1, rewardType='val', **config.reward_model.get("reward_kwargs", {})
        )
