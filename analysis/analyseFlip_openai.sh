...
# ### with summary CA + LA
# python driftDetection_OpenAI.py --input '/nas-ssd2/joykirat/code/verl-fork/verl/scripts/train/verlCheckpoint/CorrectnessOnly/qwen4b_dapo_math_10k_correctnessOnly/rollout/val_140_v0.jsonl' --output answerDrift/correctnessOnly/qwen4b_10k_correctnessOnly_aime_openai_strict.jsonl --data_source 'math-aime'
...
# python driftDetection_OpenAI.py --input $BaseModelPath --output answerDrift/baseModel/qwen4b_10k_base_gpqa_openai_answer_extraction.jsonl --data_source 'gpqa'
# python driftDetection_OpenAI.py --input $CorrectnessOnlyPath --output answerDrift/correctnessOnly/qwen4b_10k_correctnessOnly_gpqa_openai_answer_extraction.jsonl --data_source 'gpqa'
# python driftDetection_OpenAI.py --input $no_summary_path --output answerDrift/noSummary/qwen4b_10k_no_summary_gpqa_openai_answer_extraction.jsonl --data_source 'gpqa'
# python driftDetection_OpenAI.py --input $ourMethodPath --output answerDrift/withSummary/qwen4b_10k_with_summary_attention_gpqa_openai_answer_extraction.jsonl --data_source 'gpqa'

# python driftDetection_OpenAI.py --input $BaseModelPath --output answerDrift/baseModel/qwen4b_10k_base_amc_openai_answer_extraction.jsonl --data_source 'math-amc'
# python driftDetection_OpenAI.py --input $CorrectnessOnlyPath --output answerDrift/correctnessOnly/qwen4b_10k_correctnessOnly_amc_openai_answer_extraction.jsonl --data_source 'math-amc'
# python driftDetection_OpenAI.py --input $no_summary_path --output answerDrift/noSummary/qwen4b_10k_no_summary_amc_openai_answer_extraction.jsonl --data_source 'math-amc'
# python driftDetection_OpenAI.py --input $ourMethodPath --output answerDrift/withSummary/qwen4b_10k_with_summary_attention_amc_openai_answer_extraction.jsonl --data_source 'math-amc'


# python driftDetection_OpenAI.py --input $BaseModelPath --output answerDrift/baseModel/qwen4b_10k_base_aime_openai_answer_extraction.jsonl --data_source 'math-aime' 
# python driftDetection_OpenAI.py --input $CorrectnessOnlyPath --output answerDrift/correctnessOnly/qwen4b_10k_correctnessOnly_aime_openai_answer_extraction.jsonl --data_source 'math-aime'
# python driftDetection_OpenAI.py --input $no_summary_path --output answerDrift/noSummary/qwen4b_10k_no_summary_aime_openai_answer_extraction.jsonl --data_source 'math-aime'
# python driftDetection_OpenAI.py --input $ourMethodPath --output answerDrift/withSummary/qwen4b_10k_with_summary_attention_aime_openai_answer_extraction.jsonl --data_source 'math-aime'
...
python driftDetection_OpenAI.py --input $no_summary_path --output answerDrift/noSummary/qwen4b_10k_no_summary_underthink.jsonl --data_source 'underthink-bench'
python driftDetection_OpenAI.py --input $ourMethodPath --output answerDrift/withSummary/qwen4b_10k_with_summary_attention_underthink.jsonl --data_source 'underthink-bench'
...
# python driftDetection_OpenAI.py --input $BaseModelPath --output answerDrift/baseModel/qwen4b_10k_base_amc.jsonl --data_source 'math-amc'
# python driftDetection_OpenAI.py --input $CorrectnessOnlyPath --output answerDrift/correctnessOnly/qwen4b_10k_correctnessOnly_amc.jsonl --data_source 'math-amc'
# python driftDetection_OpenAI.py --input $no_summary_path --output answerDrift/noSummary/qwen4b_10k_no_summary_amc.jsonl --data_source 'math-amc'
# python driftDetection_OpenAI.py --input $ourMethodPath --output answerDrift/withSummary/qwen4b_10k_with_summary_attention_amc.jsonl --data_source 'math-amc'
...
# python driftDetection_OpenAI.py --input $BaseModelPath --output answerDrift/baseModel/qwen4b_10k_base_bbh.jsonl --data_source 'bbh'
# python driftDetection_OpenAI.py --input $CorrectnessOnlyPath --output answerDrift/correctnessOnly/qwen4b_10k_correctnessOnly_bbh.jsonl --data_source 'bbh'
# python driftDetection_OpenAI.py --input $no_summary_path --output answerDrift/noSummary/qwen4b_10k_no_summary_bbh.jsonl --data_source 'bbh'
# python driftDetection_OpenAI.py --input $ourMethodPath --output answerDrift/withSummary/qwen4b_10k_with_summary_attention_bbh.jsonl --data_source 'bbh'
