...
def curate_mip_question_dataset():
    import json
    with open('MiP-Overthinking/combined_dataset.json', 'r') as f:
        data = json.load(f)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="./mip_test_dataset")
    parser.add_argument("--hdfs_dir", default=None)

    args = parser.parse_args()

    mip_question_dataset = curate_mip_question_dataset()
    mip_insufficient_dataset = curate_mip_insufficient_dataset()


    dataset = datasets.concatenate_datasets([mip_question_dataset, mip_insufficient_dataset])
