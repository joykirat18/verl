...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="blocksworld_state_action_lazy")
...
During the reasoning process, you must first write the action that you too within the <action> </action> tags and then write the state of the problem within the <state> </state> tags.
...
"""
            ...
            data = {
                "data_source": 'blocksworld-state-action-lazy',
                "prompt": prompt,
                "ability": "math",
