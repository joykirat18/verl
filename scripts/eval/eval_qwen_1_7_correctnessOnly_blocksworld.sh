...
EXPERIMENT_NAME=qwen1_7b_blocksworld_correctness_only
WANDB_API_KEY='c8f694b1460eaf8f06beec994e5aa1bb56183688'
SAVE_PATH=/nas-ssd2/joykirat/code/state-representation/verl/scripts/train/checkpoints/blocksworld/base/$EXPERIMENT_NAME
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/nas-ssd2/joykirat/code/state-representation/verl/scripts/data/blocksworld/train.parquet \
    data.val_files=/nas-ssd2/joykirat/code/state-representation/verl/scripts/data/blocksworld/eval.parquet \
