...
EXPERIMENT_NAME=deepseek_qwen_dapo_math_10k_correctnessOnly
WANDB_API_KEY='c8f694b1460eaf8f06beec994e5aa1bb56183688'
SAVE_PATH=/nas-ssd2/joykirat/code/verl-fork/verl/scripts/train/verlCheckpoint/CorrectnessOnly/$EXPERIMENT_NAME
...
python3 -m verl.trainer.main_ppo \
    ...
    data.val_files=/nas-ssd2/joykirat/code/verl-fork/verl/scripts/data/bbeh_test_dataset/test.parquet \
    ...
    reward_model.reward_manager=correctnessOnly \
