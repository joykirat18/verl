...
EXPERIMENT_NAME=deepseek_qwen_lc_r1
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/nas-ssd2/joykirat/code/verl-fork/baselines/LC-R1/scripts/DeepSeek-R1-Distill-Qwen-7B-LCR1/ckpt/checkpoint-125 \
