...
EXPERIMENT_NAME=qwen4b_dapo_math_10k_context_linear_reward_with_summary_confidence_high_compression
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.summary_mode=confidence_scores \
