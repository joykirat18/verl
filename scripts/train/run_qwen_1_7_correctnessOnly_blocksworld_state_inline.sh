...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/nas-ssd2/joykirat/code/state-representation/verl/scripts/data/blocksworld_state_inline/train.parquet \
    data.val_files=/nas-ssd2/joykirat/code/state-representation/verl/scripts/data/blocksworld_state_inline/eval.parquet \
