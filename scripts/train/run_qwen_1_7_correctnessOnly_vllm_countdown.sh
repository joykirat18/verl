...
EXPERIMENT_NAME=qwen1_7b_countdown_task_4k_correctness_only
WANDB_API_KEY='c8f694b1460eaf8f06beec994e5aa1bb56183688'
SAVE_PATH=checkpoints/countdown/base/$EXPERIMENT_NAME
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/nas-ssd2/joykirat/code/latent-reasoning-project/verl/scripts/data/countDown/train.parquet \
    data.val_files=/nas-ssd2/joykirat/code/latent-reasoning-project/verl/scripts/data/countDown/test.parquet \
    ...
    trainer.project_name='multi-token-reasoning' \
