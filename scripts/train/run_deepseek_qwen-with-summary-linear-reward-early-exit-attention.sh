...
EXPERIMENT_NAME=deepseek_qwen_7b_dapo_math_10k_context_linear_reward_with_summary_early_exit_attention_v2
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.summary_mode=early_exit_attention_weights \
