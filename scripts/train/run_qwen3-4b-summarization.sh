...
PROJECT_NAME=TML
EXPERIMENT_NAME=qwen-3-4B-summary
NNODES=1
N_GPUS_PER_NODE=4
SAVE_FREQ=50
TEST_FREQ=10
...
TRAIN_FILES=../data/numina_dataset/train.parquet
TEST_FILES=../data/eval_dataset/AMC.parquet
REWARD_MANAGER=sum
REWARD_SCORE_PATH=../../verl/utils/reward_score/math_verify_sum.py
...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=$REWARD_SCORE_PATH \
