...
EXPERIMENT_NAME=qwen1_7b_countdown_correctness_only
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/nas-ssd2/joykirat/code/state-representation/verl/scripts/data/countDown/train.parquet \
    data.val_files=/nas-ssd2/joykirat/code/state-representation/verl/scripts/data/countDown/test.parquet \
