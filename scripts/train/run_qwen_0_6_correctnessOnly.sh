...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/nas-ssd2/joykirat/code/latent-reasoning-project/verl/scripts/data/zebraLogic/train.parquet \
    data.val_files=/nas-ssd2/joykirat/code/latent-reasoning-project/verl/scripts/data/zebraLogic/test.parquet \
    ...
    actor_rollout_ref.rollout.early_stopping_entropy_threshold=0.0 \
    ...
    actor_rollout_ref.rollout.val_kwargs.early_stopping_entropy_threshold=0.0 \
