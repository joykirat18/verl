...
EXPERIMENT_NAME=qwen1_7b_countdown_state_v0
WANDB_API_KEY='c8f694b1460eaf8f06beec994e5aa1bb56183688'
SAVE_PATH=checkpoints/countdown/state/$EXPERIMENT_NAME
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/nas-ssd2/joykirat/code/state-representation/verl/scripts/data/countDown-state/train.parquet \
    data.val_files=/nas-ssd2/joykirat/code/state-representation/verl/scripts/data/countDown-state/test.parquet \
