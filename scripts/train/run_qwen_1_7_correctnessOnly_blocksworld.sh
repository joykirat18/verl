...
EXPERIMENT_NAME=qwen1_7b_blocksworld_correctness_only_sft_v0
WANDB_API_KEY='c8f694b1460eaf8f06beec994e5aa1bb56183688'
SAVE_PATH=checkpoints/blocksworld/base/$EXPERIMENT_NAME
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/home/joykirat18/verl/scripts/data/blocksworld/train.parquet \
    data.val_files=/home/joykirat18/verl/scripts/data/blocksworld/eval.parquet \
    ...
    actor_rollout_ref.model.path=/home/joykirat18/verl/checkpoints/blocksworld_basic_sft \
