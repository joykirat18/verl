...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="deepMath_dataset/2k")
    ...
    final_train_dataset.to_parquet(train_parquet_path)
    test_dataset.to_parquet(test_parquet_path)

    print("Length of train data: ", len(final_train_dataset))
